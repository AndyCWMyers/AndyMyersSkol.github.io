...
test("viewer adds no reCAPTCHA footer", async () => {
  assert.doesNotMatch(await pdfViewerResponse('/andrew_c_w_myers_CV.pdf').text(), /protected by reCAPTCHA|acwRecaptchaNotice/);
});
